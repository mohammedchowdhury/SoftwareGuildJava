...
public class ClassRosterServiceLayerImplTest {
  ...
  private ClassRosterServiceLayer service; //Interface

public ClassRosterServiceLayerImplTest() {
    ClassRosterDao dao = new ClassRosterDaoStubImpl(); // fake dao
    ClassRosterAuditDao auditDao = new ClassRosterAuditDaoStubImpl(); // fake audit file
